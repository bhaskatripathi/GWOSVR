...
Sanitized-GWO-SVR.
This code Optimizes a Support Vector machine by using Grey Wolf Optimizer with Time varying acceleration coefficients and applying difference mean based perturbation. The original algorithm of GWO was developed by Dr Ali Mirjalili in Matlab. I was inspired by his method and Hybridized it with an SVR objective function (or SVC depending upon what you need). 
